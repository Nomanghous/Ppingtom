    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitdue') ? 'is-invalid' : '' }}" type="number" name="latitdue" id="latitdue" value="{{ old('latitdue', '-33.23123123123') }}" step="0.0000000001" required>
